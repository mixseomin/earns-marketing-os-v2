  ...
  return (
    ...
    >
      <div style={{ padding: 16, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
        ...
        <p style={{ gridColumn: '1 / -1', margin: 0, fontSize: 11, color: 'var(--fg-3)' }}>
          Persona tạo cho project hiện tại. Dùng cho nhiều project khác: Architecture Studio → Persona → cột projects (✎) hoặc drawer.
        </p>
