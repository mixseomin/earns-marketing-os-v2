...
export async function listAccountsByProject(projectId?: string) {
  ...
  return db
    .select({
      ...
      linkedAccounts: platformAccounts.linkedAccounts,
      accountKind: platformAccounts.accountKind,
