-- Persist the AI-condensed short version of a draft (prep_payload.draft_short) so it survives
-- reopening the drawer — no re-generation each time. Appended → CREATE OR REPLACE is safe.
