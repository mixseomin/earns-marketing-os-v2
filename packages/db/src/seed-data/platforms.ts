...
const PLATFORMS_RAW: PlatformDef[] = [
  ...
  },
  {
    ...
    signupUrl: 'https://www.crunchbase.com/register', postUrl: 'https://www.crunchbase.com/',
    priority: 'medium', fallbackKeys: [], iconSlug: 'crunchbase', imageSpecs: [], autoCheck: false,
    checklist: [item('email_verified', 'creating', 'https://www.crunchbase.com/register', 'Verify email.'), item('company_profile', 'warming', undefined, 'Add the company profile; link the website (dofollow). Editing needs review.'), item('api_key', 'warming', undefined, 'SPECIAL: org listing edits often gated behind a partner/contributor flow.')],
  },
  {
    key: 'hackernoon', label: 'HackerNoon',
    signupUrl: 'https://hackernoon.com/signup', postUrl: 'https://app.hackernoon.com/new',
    priority: 'medium', fallbackKeys: ['devto', 'medium'], iconSlug: 'hackernoon', imageSpecs: [], autoCheck: false,
    checklist: [item('profile_complete', 'creating', undefined, 'Bio + avatar + website.'), item('editorial_ok', 'warming', undefined, 'First article goes through editorial review before publishing.')],
  },
  {
    key: 'flipboard', label: 'Flipboard',
    signupUrl: 'https://flipboard.com/signup', postUrl: 'https://flipboard.com/',
    priority: 'medium', fallbackKeys: [], iconSlug: 'flipboard', imageSpecs: [{ kind: 'avatar', label: 'Avatar', w: 400, h: 400 }], autoCheck: false,
    checklist: [item('magazine_setup', 'creating', undefined, 'Create a curated Magazine; flip your own links in.')],
  },
  {
    key: 'webcatalog', label: 'WebCatalog',
    signupUrl: 'https://webcatalog.io/', postUrl: 'https://webcatalog.io/apps/submit',
    priority: 'medium', fallbackKeys: ['alternativeto', 'saashub'], iconSlug: 'webcatalog', imageSpecs: [], autoCheck: false,
    checklist: [item('account_verified', 'creating', undefined, 'Verify account → self-serve submit (dofollow).')],
  },
  {
    key: 'softpedia', label: 'Softpedia',
    signupUrl: 'https://www.softpedia.com/user/register.shtml', postUrl: 'https://www.softpedia.com/user/submit.shtml',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('account', 'creating', undefined, 'Register → submit; goes through editor review (free listing).')],
  },
  {
    key: 'slant', label: 'Slant.co',
    signupUrl: 'https://www.slant.co/', postUrl: 'https://www.slant.co/',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('profile', 'creating', undefined, 'Sign up; recommend the tool on the right "best X" question.')],
  },
  {
    key: 'govloop', label: 'GovLoop',
    signupUrl: 'https://www.govloop.com/register/', postUrl: 'https://www.govloop.com/',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('profile', 'creating', undefined, 'Gov/public-sector persona; profile + blog post.')],
  },
  {
    key: 'rallypoint', label: 'RallyPoint',
    signupUrl: 'https://www.rallypoint.com/', postUrl: 'https://www.rallypoint.com/',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('military_verify', 'creating', undefined, 'Military verification; profile + share useful posts.')],
  },
  {
    key: 'fedweek', label: 'FEDweek Forum',
    signupUrl: 'https://www.fedweek.com/forum/', postUrl: 'https://www.fedweek.com/forum/',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('email_verified', 'creating', undefined, 'Register forum acct; answer FERS/TSP/pay threads.')],
  },
  {
    key: 'pebforum', label: 'PEB Forum',
    signupUrl: 'https://www.pebforum.com/', postUrl: 'https://www.pebforum.com/',
    priority: 'medium', fallbackKeys: [], iconSlug: 'xenforo', imageSpecs: [], autoCheck: false,
    checklist: [item('email_verified', 'creating', undefined, 'Register; signature link (dofollow). May have approval queue.')],
  },
  {
    key: 'expat-com', label: 'Expat.com',
    signupUrl: 'https://www.expat.com/', postUrl: 'https://www.expat.com/en/forum/',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('profile', 'creating', undefined, 'Profile + email verify; answers + signature link.')],
  },
  {
    key: 'visajourney', label: 'VisaJourney',
    signupUrl: 'https://www.visajourney.com/forums/register/', postUrl: 'https://www.visajourney.com/forums/',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('email_verified', 'creating', undefined, 'Register; answers + low-key signature. Age/post-count gate before links.')],
  },
  {
    key: 'immigration-forums', label: 'Immigration.com Forums',
    signupUrl: 'https://forums.immigration.com/register/', postUrl: 'https://forums.immigration.com/',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('email_verified', 'creating', undefined, 'Register; profile signature. Approval may apply.')],
  },
  {
    key: 'stackexchange', label: 'Stack Exchange (Money.SE)',
    signupUrl: 'https://money.stackexchange.com/users/signup', postUrl: 'https://money.stackexchange.com/',
    priority: 'medium', fallbackKeys: ['stackoverflow'], iconSlug: 'stackexchange', imageSpecs: [], autoCheck: false,
    checklist: [item('email_verified', 'creating', undefined, 'Verify email.'), item('reputation', 'warming', undefined, 'SPECIAL: need rep before posting links (answer 2-3 Qs first).')],
  },
  {
    key: 'featured', label: 'Featured.com',
    signupUrl: 'https://featured.com/experts/sign-up', postUrl: 'https://featured.com/',
    priority: 'medium', fallbackKeys: ['sourceofsources', 'qwoted'], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('expert_verify', 'creating', undefined, 'Expert profile verification; weekly Q&A citing the tool.')],
  },
  {
    key: 'sourceofsources', label: 'Source of Sources',
    signupUrl: 'https://sourceofsources.com/', postUrl: 'https://sourceofsources.com/',
    priority: 'medium', fallbackKeys: ['featured'], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('email_signup', 'creating', undefined, 'Sign up as a source; answer journalist queries (free HARO successor).')],
  },
  {
    key: 'mentionmatch', label: 'MentionMatch',
    signupUrl: 'https://mentionmatch.com/', postUrl: 'https://mentionmatch.com/',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('profile', 'creating', undefined, 'Profile; answer finance queries (ex-Help a B2B Writer).')],
  },
  {
    key: 'sourcebottle', label: 'SourceBottle',
    signupUrl: 'https://www.sourcebottle.com/', postUrl: 'https://www.sourcebottle.com/',
    priority: 'medium', fallbackKeys: [], iconSlug: '', imageSpecs: [], autoCheck: false,
    checklist: [item('email_verified', 'creating', undefined, 'Register; answer Business/Finance + Government calls.')],
  },
  {
