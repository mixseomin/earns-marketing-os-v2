...
export function SeoSitesTable({ rows, timeseries, totals, initialCols }: Props) {
  ...
  const columns: DataColumn<RowData>[] = [
    ...
    {
      key: 'site', align: 'left', width: '100%', header: 'Site',
      cell: (r) => (
        <>
          {r.project
    ...
    // ── Live (GA4 realtime) ──
    {
      key: 'live5', group: 'live', align: 'right', headerAlign: 'center',
    ...
    {
      key: 'live30', group: 'live', header: <span className="live-text">30m</span>,
    ...
    // ── Interactions (GA4 custom events, 7d) ──
    {
      key: 'interactions', group: 'interactions', header: 'Inter',
    ...
    // ── Bing ──
    {
      key: 'bing_impr', group: 'bing', header: 'Impr', title: 'Bing impressions last 7 days · click a cell → Bing search keywords',
    ...
    {
      key: 'bing_clk', group: 'bing', header: 'Clk', title: 'Bing clicks last 7 days',
    ...
    {
      key: 'bing_idx', group: 'bing', header: 'Idx', title: 'Pages currently in the Bing index (latest snapshot)',
    ...
    {
      key: 'bing_links', group: 'bing', header: 'Links', title: 'Inbound links (backlinks) — Bing count · click a cell → Bing Backlinks report',
    ...
    {
      key: 'bing_4xx', group: 'bing', header: '4xx', title: '4xx errors Bing crawler hit in last 30 days',
    ...
    {
      key: 'bl', group: 'bl', header: 'BL', title: "OUR backlink campaign: links landed / total tasks for this site. Hover a cell for the status breakdown · click → the site's backlink board",
    ...
    // ── GSC ──
    {
      key: 'gsc_impr', group: 'gsc', header: 'Impr', title: 'GSC impressions last 7 days · click a cell → Google keywords (Performance)',
    ...
    {
      key: 'gsc_clk', group: 'gsc', header: 'Clk', title: 'GSC clicks last 7 days',
    ...
    {
      key: 'gsc_ctr', group: 'gsc', header: 'CTR', title: 'Click-through rate last 7 days',
    ...
    {
      key: 'gsc_pos', group: 'gsc', header: 'Pos', title: 'Average search position last 7 days',
    ...
    {
      key: 'gsc_pages', group: 'gsc', header: 'Pages', title: 'Pages with at least 1 impression last 7 days',
      cell: (r) => r.pages_with_impressions_7d,
      onCellClick: (r) => openTool(gscConsole(r)),
      total: () => totals.pages,
    },
    {
      key: 'gsc_sites', group: 'gsc', header: 'Sites', title: 'URLs submitted via sitemap',
    ...
    // ── AdSense ──
    {
      key: 'ad_td', group: 'adsense', header: '$ TD', title: 'AdSense earnings today (intra-day estimate, refreshed hourly)',
    ...
    {
      key: 'ad_impr_td', group: 'adsense', header: 'Impr TD', title: 'AdSense ad impressions today',
    ...
    {
      key: 'ad_clk_td', group: 'adsense', header: 'Clk TD', title: 'AdSense clicks today',
    ...
    {
      key: 'ad_7d', group: 'adsense', header: '$ 7d', title: 'AdSense earnings last 7 days (USD)',
    ...
    {
      key: 'ad_rpm', group: 'adsense', header: 'RPM', title: 'AdSense RPM last 7 days (USD per 1k impressions)',
    ...
    {
      key: 'ad_impr', group: 'adsense', header: 'Impr', title: 'AdSense ad impressions last 7 days',
    ...
    {
      key: 'ad_pv', group: 'adsense', header: 'PV', title: 'AdSense page views last 7 days',
    ...
    {
      key: 'ai_7d', group: 'ai', header: 'AI 7d',
    ...
    {
      key: 'ai_28d', group: 'ai', header: 'AI 28d', title: 'AI answer-engine referred sessions, last 28 days. Hover a row for the per-engine breakdown.',
    ...
    {
      key: 'ai_review', group: 'ai', header: 'Review', title: 'Manual review/checkpoint per site — countdown to the next scheduled SEO/AI review.',
    ...
    // ── Yandex ──
    {
      key: 'ya_impr', group: 'yandex', header: 'Impr', title: 'Yandex impressions last 7 days (Yandex Webmaster / CIS). New hosts show — for a few days after being added.',
    ...
    {
      key: 'ya_clk', group: 'yandex', header: 'Clk', title: 'Yandex clicks last 7 days',
    ...
    {
      key: 'ya_idx', group: 'yandex', header: 'Idx', title: 'Pages in the Yandex search index',
    ...
    {
      key: 'ya_sqi', group: 'yandex', header: 'SQI', title: 'Yandex Site Quality Index (SQI)',
    ...
    // ── Subs (email list) ──
    {
      key: 'subs', group: 'subs', header: 'Subs', title: 'Email subscribers (list size). Sites show — until they capture emails; add the site to /opt/cgg-report/subs-pull.mjs as it gets a subscribe form.',
