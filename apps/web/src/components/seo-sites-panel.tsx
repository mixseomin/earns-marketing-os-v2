...
const SITE_META: Record<string, { project?: string; emoji: string; review?: string }> = {
  ...
  'clane.app': { emoji: '🧩' },  // trang chung các app (lên 26/09/2026): privacy/support cho app KHÔNG có tên miền riêng, clane.app/<slug>/…; GA4 555948431, GSC sc-domain, Bing. Repo ~/Me/Earns/clane-app (apps.json → build.py → deploy.sh)
  'giochap.com': { project: 'ideas', emoji: '🪔' },  // app Giỗ Chạp (I12, App Store 6816360192) — trang chủ + privacy + support; GA4 556078497, GSC sc-domain, Bing. Lên 26/09/2026
  'examweight.com': { project: 'examweight', emoji: '📋', review: '2026-10-02' },  // PTCB exam-prep (ExamWeight) — len song 18/09, Gumroad examweight.gumroad.com/l/ptcb, Google Ads asfy_04 tu 18/09 (ew_ptcb_search_us \$15/ngay). GSC+Bing onboard, GA4 554885945. SEO review dau sau 2 tuan: xem index + impressions cum 'ptcb practice test'
