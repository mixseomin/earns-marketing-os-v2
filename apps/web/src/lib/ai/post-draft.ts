...
KHÔNG viết câu trả lời mẫu, KHÔNG viết "ví dụ comment:".`
  ...
  - KHÔNG link / pitch / self-promo trừ khi phase=Seed/Direct VÀ rules cho phép`
      : null,
    ctx.contentType === 'engage'
      ? `# VIỆC NÀY LÀ TƯƠNG TÁC, KHÔNG PHẢI BÀI VIẾT
Không có nội dung để soạn. Viết KẾ HOẠCH tương tác trong nhóm này, gồm:
  1. LỌC BÀI NÀO — bài mới trong vài giờ và ĐANG ÍT tương tác (nêu ngưỡng cụ thể theo nhịp nhóm).
     Lý do: trong danh sách 3-5 người đã thả cảm xúc thì tên mình nổi lên; bài đã 200 like thì mình
     là hạt cát, tốn công mà không ai thấy.
  2. LÀM GÌ — thả cảm xúc gì, có đọc/lưu bài không, khi nào thì kèm một câu ngắn.
  3. BAO NHIÊU + DỪNG Ở ĐÂU — số bài mỗi lượt, và dấu hiệu phải dừng (spam, bị để ý).
KHÔNG viết caption, KHÔNG viết comment mẫu.`
      : null,
    (ctx.contentType === 'comment' || ctx.contentType === 'reply') ? '' : null,
