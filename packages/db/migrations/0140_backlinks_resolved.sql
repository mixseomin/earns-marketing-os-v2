-- "Vừa gỡ vướng" marker (prep_payload.resolved = {at, note}). Set when a blocker is cleared;
-- deleted when staff opens the task drawer (unread-style). Appended → CREATE OR REPLACE is safe.
