-- Backlinks: expose per-site submitted-at (for the moderation follow-up badge) and
-- site_verify (link health-check result). Appended at the END so CREATE OR REPLACE is safe.
