-- Surface prep_payload.draft_review (AI draft review state: {status, thread[], at}) as a column
-- on the backlinks view, mirroring how blocker/resolved are exposed. Additive: appended at the end
-- so CREATE OR REPLACE VIEW is legal. Drives the plays task "🔴 chờ duyệt" banner + human review thread.
